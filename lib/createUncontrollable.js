  ...
  function uncontrollable(Component, controlledValues) {
    ...
    var component = _react2['default'].createClass(_extends({
      ...
      componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
        ...
        var defaultValueChanged = function defaultValueChanged(key) {
          return utils.getValue(nextProps, utils.defaultKey(key)) !== utils.getValue(props, utils.defaultKey(key));
        };

        var clobberWithDefaultValue = function clobberWithDefaultValue(key) {
          var value = nextProps[utils.defaultKey(key)];
        ...
        keys.forEach(function (key) {
          ...
          } else if (utils.getValue(nextProps, key) === undefined && defaultValueChanged(key)) {
            clobberWithDefaultValue(key);
          }
        });
      },
